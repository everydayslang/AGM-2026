const featuredSpeakers = [
  { name: "Josh Wolfe", title: "Co-Founder & Managing Partner, Lux Capital", photo: "images/featured-speakers/Josh%20Wolfe.png", bio: "Josh Wolfe is the Co-Founder and Managing Partner of Lux Capital, where he backs scientists and engineers building companies at the frontier of deep tech, defense, and the physical sciences. He invests in the emerging and underappreciated technologies that he believes will define the decades ahead." },
  ...
  { name: "Natalie Serrino", title: "Co-Founder, Gimlet Labs", photo: "images/featured-speakers/Natalie%20Serrino.png", bio: "Natalie Serrino is a Co-Founder of Gimlet Labs, working at the intersection of AI and systems performance. Her focus is the compute, inference, and energy-efficiency challenges that increasingly shape what's possible at the AI frontier." },
  ...
  { name: "Snehal Fulzele", title: "Co-Founder & CEO, Uptiq", photo: "images/featured-speakers/Snehal%20Fulzele.png", bio: "Snehal Fulzele is the Founder and CEO of Uptiq, an enterprise AI platform purpose-built for financial services. Uptiq helps banks, credit unions, wealth management firms, and fintech companies deploy AI agents and intelligent workflows across lending, onboarding, document intelligence, compliance, and customer engagement. A serial entrepreneur, Snehal previously founded Cloud Lending Solutions, which was acquired by Q2 Holdings. He brings deep experience building vertical software companies at the intersection of financial services, automation, and AI, and is focused on making AI practical, reliable, and production-ready for highly regulated industries." },
